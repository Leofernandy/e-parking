...
<body class="bg-gray-100 font-sans">
    ...
    <script>
        ...
        document.querySelectorAll('.parking-slot').forEach(slot => {
            slot.addEventListener('click', function() {
                ...
                document.querySelectorAll('.parking-slot').forEach(s => {
                    s.classList.remove('parking-slot-selected');
                });

                // If slot is available, select it
                if (this.classList.contains('parking-slot-available')) {
                    this.classList.add('parking-slot-selected');
                    
                    // Update selected slot input
                    document.getElementById('selectedSlot').value = this.getAttribute('data-slot');
                }
            });
        });
    </script>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <button class="bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600">
                            <i class="fas fa-ticket-alt mr-2"></i>Issue Ticket
                        </button>
                        <button class="bg-green-500 text-white py-2 rounded-md hover:bg-green-600">
                            <i class="fas fa-print mr-2"></i>Print Receipt
                        </button>
                        <button class="bg-red-500 text-white py-2 rounded-md hover:bg-red-600">
                            <i class="fas fa-sync mr-2"></i>Refresh Systems
                        </button>
                    </div>
                </div>
            </div>
        ...
        <!-- Detailed Transaction Log (Updated Section) -->
